...
-- 2) 101 id öğrencinin ismini 'ALI CAN' olarak güncelleyinin
update students set student_name='ALI CAN' where student_id='101';

-- 3) 109 idli öğrencinin doğumtarihini 2010-12-11 olarak update yapın.
update students set student_dob='2010-12-11' where student_id='109';

-- 4) ilk iki veriden sonra 5 veriyi listeleyiniz
select * from students limit 5 offset 2;     

-- 5) yasi en buyyuk 4. 5.  6. kişilerin bilgilerini listeleyiniz
