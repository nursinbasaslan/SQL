...
SELECT * FROM kisiler ORDER BY adres ASC; --Ascanding(asc) yazmasakta sirali verir

-- kisiler tablosunu adres'e göre sıralayarak sorgulayınız.
SELECT * FROM kisiler ORDER BY adres DESC ; --Descanding(desc) tersten siralamasini verir

-- kisiler tablosunda maasi buyukten kucuge sıralayiniz
