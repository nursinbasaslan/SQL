...
--Personnel tablosunda sirket field'ini siliniz
alter TABLE personel drop column sirket ;

--Personnel tablosunda sehir sutununun adini ulke olarak degistirelim
...
--DDL - DROP komutu "isciler tablosunu sildi"
drop TABLE isciler;
